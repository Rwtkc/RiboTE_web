mod_signalp_ui <- function(id) {
  ns <- NS(id)
  config <- signalp_module_config()
      ...
      tags$section(
        ...
        div(
          ...
          tags$p(
            ...
            "Assess whether genes with increased or decreased Translation Efficiency are enriched for signal peptide or membrane-associated annotations."
          ),
        ...
        div(
          ...
          tags$div(
            class = "ribote-signalp-results-slot",
            react_control_host(
              id = ns("results_host"),
              control_type = "ribote-signalp-results",
