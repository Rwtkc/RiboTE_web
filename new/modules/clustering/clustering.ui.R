      ...
      tags$aside(
        ...
        div(
          ...
          div(
            ...
            react_control_host(
              id = ns("export_host"),
              control_type = "ribote-clustering-export",
      ...
      tags$section(
        ...
        div(
          ...
          tags$p(
            ...
            "Compare clustered gene patterns in TE ratio, RNA abundance, or Ribo abundance, then focus on selected regions or specific Gene IDs in the detail heatmap."
          ),
        ...
        div(
          ...
          tags$div(
            class = "ribote-clustering-results-slot",
            react_control_host(
              id = ns("results_host"),
              control_type = "ribote-clustering-results",
