      ...
      tags$aside(
        ...
        div(
          ...
          div(
            ...
            react_control_host(
              id = ns("export_host"),
              control_type = "ribote-network-export",
      ...
      tags$section(
        ...
        div(
          ...
          tags$p(
            ...
            "Build a co-expression network from TE ratio, RNA abundance, or Ribo abundance patterns to highlight genes that change together across samples."
          ),
        ...
        div(
          ...
          tags$div(
            class = "ribote-network-results-slot",
            react_control_host(
              id = ns("results_host"),
              control_type = "ribote-network-results",
