mod_data_preprocess_ui <- function(id) {
  ns <- NS(id)
      ...
      tags$aside(
        ...
        div(
          ...
          div(
            ...
            react_control_host(
              id = ns("export_host"),
              control_type = "ribote-preprocess-export",
      ...
      tags$section(
        ...
        div(
          ...
          tags$p(
            ...
            "Apply missing-value handling and CPM-based filtering to produce the processed count matrix used by downstream translation analysis."
          ),
